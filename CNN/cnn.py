...
def classify_img_from_file(img_path, model_path, img_dim=28):
    ...
    return __classify_img(img4D, model_path)

def classify_img_from_dataset(dataset_path, model_path, index, img_dim=28):
    ...
    return __classify_img(img, model_path)
...
def __classify_img(img4D, model_path):
