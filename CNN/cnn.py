...
def train(dataset_path, img_dim=28, learning_rate=0.1, n_epochs=200, kernel_dim=(5, 5), nkerns=(20, 50), mlp_layers=(500, 10), batch_size= 500, pool_size= (2, 2)):
...
def __classify_img(img4D):
    ...
    save_file = open('D:\\_Dataset\\cnn_model.pkl', 'rb')
    loaded_objects = []
    for i in range(14):
